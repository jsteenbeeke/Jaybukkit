...
public class AdminBlockCommand extends PlayerAwareCommandHandler {
	private final JayClaim jayClaim;

	private static final String ARG_ADMIN = "admin";

	private static final String COMMAND_ARG = "block";

	public AdminBlockCommand(JayClaim jayClaim) {
	...
	public void onAuthorizedAndPlayerFound(Player player, Command command,
		...
		jayClaim.setClaimed(player.getLocation());
	}
